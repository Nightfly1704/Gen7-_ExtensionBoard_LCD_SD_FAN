...
void ui_init_keys() {
#if UI_HAS_KEYS!=0
  UI_KEYS_INIT_CLICKENCODER_LOW(21,20); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
  UI_KEYS_INIT_BUTTON_LOW(11); // push button, connects gnd to pin
...
void ui_check_keys(int &action) {
 ...
 UI_KEYS_CLICKENCODER_LOW_REV(21,20); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
 UI_KEYS_BUTTON_LOW(11,UI_ACTION_OK); // push button, connects gnd to pin
