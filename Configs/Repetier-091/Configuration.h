...
#define EXT0_STEPS_PER_MM 380 //385
...
#define X_MAX_LENGTH 217
#define Y_MAX_LENGTH 222
...
/** After x seconds of inactivity, the stepper motors are disabled.
    ...
    Overridden if EEPROM activated.
*/
#define STEPPER_INACTIVE_TIME 3000
/** After x seconds of inactivity, the system will go down as far it can.
    ...
    Overridden if EEPROM activated.
*/
#define MAX_INACTIVE_TIME 1800000
...
#define UI_PRINTER_NAME "Mendel90"
#define UI_PRINTER_COMPANY "ABC-Design"
